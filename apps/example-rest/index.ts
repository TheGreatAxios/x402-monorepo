...
const { EVM_RECEIVING_ADDRESS, PORT } = process.env as Record<
	string,
	string | undefined
>;

const payTo =
	EVM_RECEIVING_ADDRESS ?? "0x0000000000000000000000000000000000000001";
...
app.use(
	...
	paymentMiddleware(
		...
		{
			description: "USDC Forwarder example",
