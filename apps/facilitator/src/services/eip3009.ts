...
export async function verifyEIP3009Authorization(auth: EIP3009Auth): Promise<boolean> {
  const domain = {
...
export async function verifyEIP3009Forwarder(auth: EIP3009ForwarderAuth): Promise<boolean> {
  const domain = {
